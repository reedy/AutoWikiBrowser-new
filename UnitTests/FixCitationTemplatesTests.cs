...
Bar}} was"), Is.EqualTo(@"now {{cite web| url=a.com|title=hello world|publisher=Foo Bar}} was"), "newline converted to space, any parameter");
        ...
        public void FixCitationTemplatesQuotedTitle()
        {
            ...
            Assert.That(Parsers.FixCitationTemplates(@"now {{cite web| url=a.com|trans_title=‘hello today’|format=PDF}} was"), Is.EqualTo(@"now {{cite web| url=a.com|trans_title='hello today'|format=PDF}} was"), "single curly quote open and close");
...
publisher=The BBC|date=3 June 2009|access-date=15 January 2010}}"));
        ...
        public void FixCitationTemplatesArchiveUrls()
        {
            ...
            Assert.That(Parsers.FixCitationTemplates(@"{{cite news|title=Initiative is withdrawn|url=http://web.archive.org/web/20120930101428/http://www.swissinfo.ch/eng/swiss_news/Initiative_is_withdrawn.html?cid=26670404|access-date=25 August 2010|website=archive.org|date=25 August 2010}}"), Is.EqualTo(@"{{cite news|title=Initiative is withdrawn|url=http://www.swissinfo.ch/eng/swiss_news/Initiative_is_withdrawn.html?cid=26670404|access-date=25 August 2010|date=25 August 2010|archive-url=http://web.archive.org/web/20120930101428/http://www.swissinfo.ch/eng/swiss_news/Initiative_is_withdrawn.html?cid=26670404|archive-date=2012-09-30}}"), "URL is web.archive.org");
            Assert.That(Parsers.FixCitationTemplates(@"{{cite news|title=Initiative is withdrawn|url=http://web.archive.org/web/20120930101428/http://www.swissinfo.ch/eng/swiss_news/Initiative_is_withdrawn.html?cid=26670404|access-date=25 August 2010|website=web.archive.org|date=25 August 2010}}"), Is.EqualTo(@"{{cite news|title=Initiative is withdrawn|url=http://www.swissinfo.ch/eng/swiss_news/Initiative_is_withdrawn.html?cid=26670404|access-date=25 August 2010|date=25 August 2010|archive-url=http://web.archive.org/web/20120930101428/http://www.swissinfo.ch/eng/swiss_news/Initiative_is_withdrawn.html?cid=26670404|archive-date=2012-09-30}}"), "URL, website is web.archive.org");
        }
    }
}