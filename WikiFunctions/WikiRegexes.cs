...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        private static readonly List<string> MultipleIssuesArticleMaintenanceTemplatesList = new[]
        {
            ...
            "Confusing", "Content", "Context", "Contradicts other", "Contradicts others", "Copy edit",
            "Copy to Wikibooks", "Copy to Wikiquote", "Copy to Wikisource", "Copy to Wikiversity", "Copy to Wikivoyage", "Copypaste", "Create list", "Criticism section", "Current", "Current person", "Current related", "Current spaceflight", "Current sport", "Current weather event", "Dablinks", "Dead end", "Dicdef", "Directory", "Dispute about", "Disputed", "Disputed category", "Disputed chem", "Disputed list", "Disputed map", "Duplicated citations", "Duplication", "EBD POV", "Essay", "Essay-like",
