...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        {
            "Abbreviations", "All plot", "Alumni", "Autobiography", "Biblio", "BLP IMDb refimprove",
            "BLP primary sources", "BLP sources", "BLP unreferenced", "Buzzword", "Citations broken",
            "Citation style", "Cite check", "Cleanup", "Cleanup bare URLs", "Cleanup biography",
            ...
            "Confusing", "Context", "Contradicts other", "Copy edit",
            "Criticism section", "Dead end", "Disputed", "Dynamic list", "Essay", "Essay-like",
            "Excessive examples", "Expert needed", "External links", "Fan POV",
            ...
            "Long plot", "Merge", "Merge from", "Merge to", "Missing information", "More citations needed",
            "More footnotes needed", "More medical citations needed", "Neologism",
            "No footnotes", "No significant coverage", "Non-free", "Notability", "NPOV language", "Obituary", "One source",
            "Original research", "Orphan", "Overlinked",
            "Overly detailed", "Over-quotation", "Page numbers needed", "Paid contributions", "Peacock", "POV",
            "Primary sources", "Promotional", "Prose", "Recentism", "Religious text primary",
            "Resume-like", "Review", "Sections", "Self-contradictory", "Self-published", "Sources exist", "Spam-request", "Speculation", "Split", "Story",
            "Synthesis", "Technical", "Tone", "Too few opinions", "Too many sections", "Travel guide",
            "Trivia", "Unbalanced", "Under construction", "Underlinked", "Undisclosed paid", "Undue weight", "Unfocused", "Unreferenced",
            "Unreliable sources", "Unsorted list", "Update", "USgovtPOV", "Use list-defined references", "Very long", "Weasel", "Wikify",
            ...
            "Expand Norwegian (Nynorsk)", "Expand Ossetian", "Expand Papiamento", "Expand Pashto", "Expand Persian",
            "Expand Polish", "Expand Portuguese", "Expand Punjabi", "Expand Quechua", "Expand Romanian",
            ...
            "Expand Serbo-Croatian", "Expand Shona", "Expand Sicilian", "Expand Sindhi", "Expand Sinhalese",
            "Expand Slovak", "Expand Slovenian", "Expand Somali", "Expand Sotho", "Expand Spanish", "Expand Sundanese",
