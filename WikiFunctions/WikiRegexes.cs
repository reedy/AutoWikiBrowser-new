...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        {
            "Abbreviations", "Advert", "All plot", "Alumni", "Autobiography", "Biblio", "BLP IMDb refimprove",
            "BLP primary sources", "BLP sources", "BLP unreferenced", "BLP unsourced", "Buzzword", "Citations broken",
            ...
            "Criticism section", "Crystal", "Dead end", "Disputed", "Dynamic list", "Editorial", "Essay", "Essay-like", "Example farm",
            "Excessive examples", "Expand article", "Expert needed", "Expert-subject", "External links", "Fanpov", "Fan POV",
            "Fiction", "Format footnotes", "Full citations needed", "Game guide", "Generalize", "Globalize", "Hoax", "How-to", "Howto",
            "Improve lead", "Inadequate lead", "Inappropriate person", "Incoherent", "Incomplete", "Incomplete list", "In-universe",
            "Lead missing", "Lead rewrite", "Lead too long", "Lead too short", "Like resume", "Local", "Localist",
            "Long plot", "Magazine", "Manual", "Medref", "Missing information", "More citations needed",
            "More footnotes", "More footnotes needed", "More medical citations needed", "MOS", "MOSLOW", "Neologism",
            ...
            "Unreliable sources", "Update", "USgovtPOV", "Use list-defined references", "Very long", "Weasel", "Wikify",
