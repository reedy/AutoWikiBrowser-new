...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        private static readonly List<string> MultipleIssuesArticleMaintenanceTemplatesList = new[]
        {
            ...
            "Subsections", "Summary style", "Synthesis", "Technical", "Term paper", "Text-source", "Textbook", "Time-context", "Tone", "Too few opinions", "Too many charts", "Too many photos", "Too many list sections", "Too many sections", "Translated page", "Travel guide",
