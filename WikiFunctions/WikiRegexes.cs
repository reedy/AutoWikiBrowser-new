...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        {
            "Abbreviations", "Academic booster", "Accessibility dispute", "AI-generated", "All plot", "Alumni", "Anachronism", "Autobiography", "Better sources needed", "Biblio", "BLP IMDb-only refimprove", "BLP IMDb refimprove", "BLP more footnotes needed",
            ...
            "Copy to Wikibooks", "Copy to Wikiquote", "Copy to Wikisource", "Copy to Wikiversity", "Copy to Wikivoyage", "Copypaste", "Create list", "Criticism section", "Current", "Current person", "Current related", "Current spaceflight", "Current sport", "Current weather event", "Dablinks", "Dead end", "Dicdef", "Directory", "Dispute about", "Disputed", "Disputed category", "Disputed chem", "Disputed list", "Disputed map", "Duplicated citations", "Duplication", "Dynamic list", "EBD POV", "Essay", "Essay-like",
            ...
            "Lacking ISBN", "Lacking overview", "Lead extra info", "Lead missing", "Lead rewrite", "Lead too long", "Lead too short", "List to table", "List years", "Localist",
            ...
            "Subsections", "Summary style", "Synthesis", "Technical", "Term paper", "Text-source", "Textbook", "Time-context", "Tone", "Too few opinions", "Too many charts", "Too many photos", "Too many sections", "Translated page", "Travel guide",
            ...
            "Unreliable sources", "Unsorted list", "Update", "Update-EB", "USgovtPOV", "Use list-defined references", "User-generated", "Verifiability", "Verify sources", "Very long", "Weasel", "Wikify", "You",
