...
namespace WikiFunctions
{
    ...
    public static class WikiRegexes
    {
        ...
        private static readonly List<string> MultipleIssuesArticleMaintenanceTemplatesList = new[]
        {
            ...
            "Cleanup tense", "Cleanup translation", "Cleanup weighted", "Close paraphrasing", "Coatrack", "COI", "Colloquial",
            "Confusing", "Content", "Context", "Contradicts other", "Contradicts others", "Convert to Episode table", "Copy edit",
            "Copy to Wikibooks", "Copy to Wikiquote", "Copy to Wikisource", "Copy to Wikiversity", "Copy to Wikivoyage", "Copypaste", "Create list", "Criticism section", "Current", "Current election", "Current person", "Current related", "Current spaceflight", "Current sport", "Current weather event", "Dablinks", "Dead end", "Dicdef", "Directory", "Dispute about", "Disputed", "Disputed category", "Disputed chem", "Disputed list", "Disputed map", "Duplicated citations", "Duplication", "EBD POV", "Essay", "Essay-like",
            "Excessive citations", "Excessive examples", "Exit list", "Expert needed", "External links", "Famous", "Fan POV",
            "Fiction", "Fiction trivia", "Format footnotes", "Fringe theories", "Full citations needed", "Further reading cleanup", "Game guide", "Generalize", "Geographic imbalance", "Globalize", "Hoax", "Hook", "How-to", "Improve images",
            ...
            "More footnotes needed", "More medical citations needed", "More plot", "More science citations needed", "Mycomorphbox missing", "Needs table", "Neologism", "New name",
            ...
            "Overly detailed", "Over-quotation", "Page numbers improve", "Page numbers needed", "Paid contributions", "Parenthetical referencing", "Peacock", "POV", "POV lead", "POV map", "Political POV",
            "Primary sources", "Pro and con list", "Proofreader needed", "Promotional", "Prose", "Recategorize", "Recent birth", "Recent death", "Recentism", "Recently revised", "Religious text primary", "Renamed", "Renamed from",
            ...
            "Subsections", "Summary style", "Synthesis", "Technical", "Term paper", "Text-source", "Textbook", "Time-context", "Title change", "Tone", "Too few opinions", "Too many charts", "Too many photos", "Too many list sections", "Too many sections", "Translated page", "Travel guide",
            "Trivia", "Unbalanced", "Unclear date", "Under construction", "Underlinked", "Undisclosed paid", "Undue weight", "Unfocused", "Units attention", "Unreferenced", "Unreferenced category", "Unreferenced law",
            "Unreliable sources", "Unsorted list", "Update", "Update-EB", "Upscaled images", "USgovtPOV", "Use list-defined references", "User-generated", "Verifiability", "Verify sources", "Very long", "Weasel", "Wikify", "You",
            ...
            "Expand Bishnupriya Manipuri", "Expand Bosnian", "Expand Breton", "Expand Bulgarian", "Expand Burmese",
            "Expand Cantonese", "Expand Catalan", "Expand Cebuano", "Expand Central Bikol", "Expand Central Kurdish",
            "Expand Chewa", "Expand Chinese", "Expand Colognian", "Expand Corsican", "Expand Crimean Tatar",
            "Expand Croatian", "Expand Czech", "Expand Danish", "Expand Dutch", "Expand Dutch Low Saxon",
            "Expand Egyptian Arabic", "Expand Emiliano-Romagnolo", "Expand Esperanto", "Expand Estonian", "Expand Ewe",
            "Expand Faroese", "Expand Finnish", "Expand French", "Expand Friulian", "Expand Galician",
            "Expand Georgian", "Expand German", "Expand Greek", "Expand Gujarati", "Expand Haitian Creole",
            "Expand Hausa", "Expand Hawaiian", "Expand Hebrew", "Expand Hindi", "Expand Hungarian", "Expand Icelandic",
            "Expand Ido", "Expand Igbo", "Expand Indonesian", "Expand Irish", "Expand Italian", "Expand Japanese",
            "Expand Javanese", "Expand Kannada", "Expand Kazakh", "Expand Khmer", "Expand Korean", "Expand Kurdish",
            "Expand Kyrgyz", "Expand language", "Expand Lao", "Expand Latin", "Expand Latvian", "Expand Lezgian",
            "Expand Limburgish", "Expand Lithuanian", "Expand Lojban", "Expand Lombard", "Expand Luxembourgish",
            "Expand Macedonian", "Expand Malagasy", "Expand Malay", "Expand Malayalam", "Expand Maltese",
            "Expand Maori", "Expand Marathi", "Expand Minangkabau", "Expand Mingrelian", "Expand Mongolian",
            "Expand Neapolitan", "Expand Nepali", "Expand North Frisian", "Expand Norwegian",
            "Expand Norwegian (Nynorsk)", "Expand Odia", "Expand Ossetian", "Expand Papiamento", "Expand Pashto", "Expand Persian",
            "Expand Polish", "Expand Portuguese", "Expand Punjabi Gurmukhi", "Expand Quechua", "Expand Romanian",
            "Expand Russian", "Expand Samoan", "Expand Samogitian", "Expand Sanskrit", "Expand Sardinian",
            "Expand Saterland Frisian", "Expand Scots", "Expand Scottish Gaelic", "Expand Serbian",
            "Expand Serbo-Croatian", "Expand Shona", "Expand Sicilian", "Expand Sindhi", "Expand Sinhala",
            "Expand Slovak", "Expand Slovene", "Expand Somali", "Expand Sotho", "Expand Spanish", "Expand Sundanese",
            "Expand Swahili", "Expand Swedish", "Expand Tagalog", "Expand Tajik", "Expand Tamil", "Expand Tatar",
            "Expand Telugu", "Expand Testlish", "Expand Thai", "Expand Tibetan", "Expand Tongan", "Expand Tswana",
